...
const StepListOfStockholders = ({ handleNext }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      nationality: listOfStockholders[0]?.nationality ? listOfStockholders[0]?.nationality : 'KR',
      ...
      <DatePickerWrapper>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Grid container spacing={4}>
            <GMETitle
              title={t('List of Stockholders')}
              subTitle={t('Please list the name (s) of stockholder (s) holding shares above 10%')}
            />
