...
const onboardingSlice = createSlice({
  ...
  reducers: {
    ...
    updateMerchantAddress: (state, {payload}) => {
      state.editBusinessAddress.postal_code= payload.postalCode;
      state.editBusinessAddress.addressLine1 = payload.address1;
      state.editBusinessAddress.addressLine2 = payload.address2;
    },
  },
