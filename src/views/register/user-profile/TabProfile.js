                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          value={value}
                          onChange={onChange}
                          label={t('Given Name (in English)')}
                          placeholder={t('Given Name')}
                          error={Boolean(errors.firstName)}
                          aria-describedby='validation-basic-first-name'
                          {...(errors.firstName && { helperText: <Translations text='This field is mandatory' /> })}
                        />
                      )}
                    />
                  </Grid>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          {...(errors.middleName && { helperText: <Translations text='This field is mandatory' /> })}
                        />
                      )}
                    />
                  </Grid>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          value={value}
                          onChange={onChange}
                          label={t('Surname (in English)')}
                          placeholder={t('Surname')}
                          error={Boolean(errors.lastName)}
                          aria-describedby='validation-basic-last-name'
                          {...(errors.lastName && { helperText: <Translations text='This field is mandatory' /> })}
                        />
                      )}
                    />
                  </Grid>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          {...(errors.phone && { helperText: <Translations text='This field is mandatory' /> })}
                          InputProps={{
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          {...(errors.address1 && { helperText: <Translations text='This field is mandatory' /> })}
                        />
                      )}
                    />
                  </Grid>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          {...(errors.address2 && { helperText: <Translations text='This field is mandatory' /> })}
                        />
                      )}
                    />
                  </Grid>
