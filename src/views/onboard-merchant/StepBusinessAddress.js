...
const businessAddressSchema = yup.object().shape({
  ...
  city: yup.string().required('This field is mandatory').max(50, 'Please enter a maximum of 50 characters.')
})
...
const StepBusinessAddress = ({ handleNext }) => {
  ...
  return (
    <Fragment>
      ...
      <DialogAddressHtml handleDialog={handleAddressDialog} show={showAddressDialog}/>
    </Fragment>
  )
}
