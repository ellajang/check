...
const FormModalRep = ({ editData, show, handleShow }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      phoneCode: editData?.phoneCode ? editData.phoneCode : '',
        ...
        <DatePickerWrapper>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid container spacing={4}>
              <GMETitle title='C.E.O Information' subTitle='Please add the name of the company representative' />
                ...
                <Controller
                  ...
                  render={({ field: { value, onChange } }) => (
                    <CustomTextField
                      ...
                      {...(errors.designation && { helperText: <Translations text='This field is required' /> })}
                      sx={{
